...
// Pasta onde o arquivo para comparacao sera salvo
$_UP['pasta'] = '/xmls_entrada/uploads_dir/';
...
if ($_UP['renomeia'] == true) {
    //Nome do arquivo:
    $nome_final = "/xmls_entrada/uploads/envio_xml_entrada.xml";
    }
}
...
if (move_uploaded_file($_FILES['arquivo']['tmp_name'],  $nome_final)) {
    ...
    echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=/xmlparser/entrada/importNFe_entrada.php'>";
